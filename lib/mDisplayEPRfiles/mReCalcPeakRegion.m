function mReCalcPeakRegion (B)
% Функция перерисовки графических элементов выбранного региона
% Пересчет и поиск максимума-минимума и основных характеристик в выбранном
% регионе ведется исходя из положения левой и правой управляющих областей
